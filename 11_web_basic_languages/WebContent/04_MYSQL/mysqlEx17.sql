...
INSERT INTO MEMBER(SCORE) VALUES(100); # ERROR : NOT NULL 컬럼의 데이터가 NULL이다.
INSERT INTO MEMBER(NAME,SCORE) VALUES('제임스 고슬링',100); # ERROR : NOT NULL 컬럼의 데이터가 NULL이다.

INSERT INTO MEMBER VALUES(1000, '제임스고슬링', 100);
INSERT INTO MEMBER VALUES(1000, '버너스리', 100); # ERROR : PRIMARY KEY가 중복되어 있다.
INSERT INTO MEMBER VALUES(1001, '버너스리', 100);
SELECT * FROM MEMBER;
DROP TABLE MEMBER;
